...
var ConstalationEffect = function () {
	...
	function ConstalationEffect(canvasId, config) {
		...
		var color = _config$color === undefined ? '#FFFFFF' : _config$color;
   ...
   */
    ...
    */
				...
				this.context.strokeStyle = 'rgba(255,255,255,' + (1 - dist / this.config.MAX_DIST_SQ) + ' )';
			}
		}
	}, {
		key: 'drawDot',
...
//# sourceMappingURL=ConstalationEffect.js.map
